export const gaugeController = [
  {
    inputs: [
      ...
      { internalType: 'address', name: '_voting_escrow', type: 'address' },
      { internalType: 'address', name: '_ownership', type: 'address' },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_gauge_type', type: 'uint256' },
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_type_id', type: 'uint256' },
      { internalType: 'uint256', name: '_weight', type: 'uint256' },
    ],
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_type_id', type: 'uint256' }],
  ...
  },
  {
    ...
    name: 'ownership',
    outputs: [
      { internalType: 'contract IOwnership', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    name: 'token',
    outputs: [
      { internalType: 'contract IInsureToken', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
