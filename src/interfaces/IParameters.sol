...
interface IParameters {
    ...
    function setRequestDuration(address _pool, uint256 _duration) external;

    function setWithdrawableDuration(address _pool, uint256 _time) external;

    function setUnlockGracePeriod(address _market, uint256 _period) external;

    function setMaxInsureSpan(address _market, uint256 _span) external;

    function setMinInsureSpan(address _market, uint256 _span) external;
